...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        add(name);
        nameTextField = new JTextField(0);
        ...
        add(fname);
        fnameTextField = new JTextField(0);
        ...
        dateChooser.setForeground(new Color(105,105,150));
        add(dateChooser);
        ...
        add(email);
        emailTextField = new JTextField(0);
        ...
        add(city);
        cityTextField = new JTextField(0);
        ...
        add(state);
        stateTextField = new JTextField(0);
