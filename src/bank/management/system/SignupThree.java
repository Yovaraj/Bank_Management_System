...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel pindetail= new JLabel("Your 4 Digit Passowrd");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        long randomNumber = Math.abs(random.nextLong()% 9000000000000000L) + 1000000000000000L; 
        String cardnumber = String.valueOf(randomNumber);
